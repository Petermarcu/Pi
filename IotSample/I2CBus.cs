...
namespace I2C.Net
{
	public class I2CBus : II2CBus, IDisposable
	{
		...
		{
            int ret = I2CNativeLib.Ioctl(busHandle, I2CNativeLib.I2C_SLAVE, address);
            ...
            ret = I2CNativeLib.Write(busHandle, bytes, bytes.Length);
		...
		public byte[] ReadBytes(int address, int count)
		{
            ...
            int n = I2CNativeLib.Read(busHandle, buf, buf.Length);
